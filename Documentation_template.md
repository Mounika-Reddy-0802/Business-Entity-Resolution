...
training entities it reaches macro F0.5 **0.9655** (US 0.976, India 0.951) at a blocking recall of
...
**Model type:** LightGBM binary classifier (learning rate 0.1, 63 leaves, feature/bagging
fraction 0.8, early stopping, seed 42), 5-fold GroupKFold by S1 entity on 200k fit-side entities
(3.97M pairs), then refit on all fit rows.
...
- **F_0.5 Score (macro):** 0.9655 on 60,000 held-out training entities (US 0.9757, India
  0.9506, singleton entities 0.969). Seed-to-seed spread of the model is ~0.001.
...
| + address-pair key and learned cap ranker (recall 0.960) | 0.9655 |
